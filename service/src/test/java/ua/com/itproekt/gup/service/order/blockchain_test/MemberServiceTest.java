...
public class MemberServiceTest {
    ...
    public void testMoneyTransferTransaction() {
         ...
         */
        try {
            MemberService bankService = new MemberService(new BuyerTransactionService(new MoneyTransferTransaction(USER_CARD, AMOUNT, PUBLIC_HASH, SIGNATURE_STORE, BANK_TRANSACTION_ID)));
            System.err.println("----------------------");
    ...
    public void testContractTransaction() {
        ...
        try {
            ...
            MemberService buyerService = new MemberService(new BuyerTransactionService(new ContractTransaction(_HASH, new String[]{SELLER_ID,BUYER_ID}, TIMESTAMP, PRODUCT_ID, PRICE)));
    ...
    public void testActionTransaction() {
        ...
        try {
            ...
            MemberService sellerService = new MemberService(new BuyerTransactionService(new ActionTransaction(_HASH, SELLER_ID, TIMESTAMP, PRODUCT_ID, PRICE, PUBLIC_HASH, ACTION_ID)));
