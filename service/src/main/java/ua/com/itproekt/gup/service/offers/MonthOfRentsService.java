...
//
//public abstract class MonthOfRentsService extends ConcurrentLinkedQueue<Status> {
//
...
//     *       -- through constructor with parameters
//     */
//    protected MonthOfRentsService(Boolean weekdayStatus, Boolean weekendStatus){
