...
//     * @param productID
//     */
//    public void setData(int logicRef, String[] members, String productID, long price)
...
//        Gson gson = new Gson();
//        String data = gson.toJson(new TransactionDataMoneyTransfer(logicRef, members, productID, price)); // пользовательские данные которые нужно зашифровать, передать и проверить...
////        MessageDigest msg = MessageDigest.getInstance("SHA-256");   // 1. Указываем тип шифрования ( формат: SHA-256 )
...
//        setData(data); //setData(Hex.toHexString(digestDATA));
//    }
//
...
////        setSignature(new TransactionSignature(Hex.toHexString(digestReadPublic))); // RSA Public Key = (String) Hex
//
