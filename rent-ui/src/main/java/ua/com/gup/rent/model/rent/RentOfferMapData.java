...
public class RentOfferMapData {
    ...
    public RentOfferMapData(){}

    public RentOfferMapData(String unit_area, String area, String id_office, String cadnum, String use, String purpose, String ownershipcode) {
    ...
    public String toString() {
        return "RentOfferMapData [unit_area = " + unit_area + ", area = " + area + ", id_office = " + id_office + ", cadnum = " + cadnum + ", use = " + use + ", purpose = " + purpose + ", ownershipcode = " + ownershipcode + "]";
    }
}
