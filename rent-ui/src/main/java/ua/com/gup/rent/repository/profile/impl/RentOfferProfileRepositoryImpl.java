...
public class RentOfferProfileRepositoryImpl extends RentOfferGenericRepositoryImpl<RentOfferProfile, String> implements RentOfferProfileRepository {
    ...
    @Override
    public List<RentOfferProfile> findUsersByManager(String managerId) {
        Query query = new Query();
    ...
    @Override
    public RentOfferProfile getManagerUser(String managerPublicId, String publicId) {
    ...
    public Set<String> getManagerUserIds(String managerId) {
        ...
        RentOfferProfile manager = mongoTemplate.findOne(query, RentOfferProfile .class);
        if(manager == null){
