            ...
            if (!rentOfferCategoryService.exists(rentOfferCreateDTO.getCategory())) {
                ...
                if (!isRentOfferUpdateDTO || (isRentOfferUpdateDTO && numberOfAllAttrs > 0)) {
                    ...
                    try {
                        ...
                        errors.rejectValue("category", "rent.offer.category." + rentOfferCreateDTO.getCategory() + ".unknown", null, "This Category not set Category Attribute please check");
                    }
                    // checking values of attrs
                    if (categoryAttributeDTOMap != null) {
