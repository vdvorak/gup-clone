...
@Component
public class RentManagerClientInfoMapper extends CommonManagerClientInfoMapper<RentClientInfoProfileShortDto, RentManagerClientInfo> {

    @Override
    public RentClientInfoProfileShortDto convert(RentManagerClientInfo info) {
