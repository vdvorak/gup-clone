...
//-------------------- OLDER -RE-FACTORING------------------------------FROM OFFER -----------------------------------------//
    ...
    public ResponseEntity<OfferViewDetailsDTO> updateOfferByModerator(@Valid @RequestBody OfferModerationReportDTO offerModerationReportDTO) {
        ...
        OfferViewDetailsDTO result = rentOfferService.save(offerModerationReportDTO);
    ...
    public ResponseEntity<OfferViewDetailsDTO> changeStatus(@PathVariable String id, @PathVariable OfferStatus status) throws URISyntaxException {
        ...
        Optional<OfferViewDetailsDTO> result = rentOfferService.updateStatus(id, status);
    ...
    public ResponseEntity<Page> getAllOffersByFilter(OfferFilter offerFilter, Pageable pageable) {
        ...
        Page<OfferViewShortDTO> page = rentOfferService.findAll(offerFilter, pageable);
        return new ResponseEntity<>(page, HttpStatus.OK);
    }
