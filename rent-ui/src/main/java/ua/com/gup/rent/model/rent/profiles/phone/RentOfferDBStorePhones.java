...
public class RentOfferDBStorePhones {

    public RentOfferDBStorePhones(){
    }

    public RentOfferDBStorePhones(String idUser, List<Long> mainPhones, List<Long> contactPhones){
        this.idUser = idUser;
