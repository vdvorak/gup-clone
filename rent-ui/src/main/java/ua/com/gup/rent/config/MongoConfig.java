...
@Configuration
@ComponentScan(basePackages = {"ua.com.gup.rent.repository", /* какой-то костыль */"ua.com.gup.rent.config"})
@EnableMongoRepositories(basePackages = "ua.com.gup.rent.repository")
