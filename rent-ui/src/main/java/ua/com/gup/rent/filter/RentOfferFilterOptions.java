...
public final class RentOfferFilterOptions extends RentOffer {
    ...
    private List<RentOfferPropertyWithValuesInterval> propertiesInterval;
    private String searchField;
    private String priceSortDirection;
    private String createdDateSortDirection;
    private boolean isMain;
    private List<RentOfferCategoryShort> favouriteCategories;
    ...
    public List<RentOfferPropertyWithValuesInterval> getPropertiesInterval() {
        return propertiesInterval;
    }

    public void setPropertiesInterval(List<RentOfferPropertyWithValuesInterval> propertiesInterval) {
    ...
    public List<RentOfferCategoryShort> getFavouriteCategories() {
        return favouriteCategories;
    }

    public void setFavouriteCategories(List<RentOfferCategoryShort> favouriteCategories) {
    ...
    public boolean equals(Object o) {
        ...
        RentOfferFilterOptions that = (RentOfferFilterOptions) o;
