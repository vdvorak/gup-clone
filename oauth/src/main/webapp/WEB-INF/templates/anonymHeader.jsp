        ...
        <%--<div id="tab-container" class="tab-container">--%>
            ...
            <%--<div id="entry-form" ng-app="app">--%>
                ...
                <%--<script>--%>
                    ...
                    <%--app.controller('AppCtrl', function($scope, $http, $location) {--%>
                        ...
                        <%--$scope.submitForm = function() {--%>
                            ...
                            <%--.success(function(data) {--%>
                                ...
                                <%--} else {--%>
                                    <%--window.location.assign("http://localhost:8081/index"); //window.location.assign("/index");--%>
                                <%--}--%>
                            <%--})--%>
                    ...
                    <%--});--%>
                <%--</script>--%>
                <%--&lt;%&ndash;<div class="view-container">&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<div ng-view class="view-frame"></div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
            <%--</div>--%>
