    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="<c:url value="/admin-offers-new" />"><i class="fa fa-credit-card fa-fw"></i>Новые
                        объявления</a>
                </li>
                <li>
                    <a href="<c:url value="/admin-offers-edited" />"><i class="fa fa-credit-card fa-fw"></i>Отредактированные
                        объявления</a>
                </li>
                <li>
