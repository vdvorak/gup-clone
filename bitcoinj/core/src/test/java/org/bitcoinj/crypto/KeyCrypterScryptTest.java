...
//    }
    ...
    @Test
    public void testKeyCrypterGood2_0() {
        System.out.println( "1. ||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||");

        System.out.println("scryptParameters: " + scryptParameters);
        KeyCrypterScrypt keyCrypter = new KeyCrypterScrypt(scryptParameters);
        ...
        System.out.println("reconstructedPlainBytes: " + reconstructedPlainBytes);

        System.out.println();

        System.out.println("plainText: " + Utils.HEX.encode(plainText.getBytes()));
        System.out.println("reconstructedPlainBytes: " + Utils.HEX.encode(reconstructedPlainBytes));
    }
...
//    }
    ...
    @Test
    public void testKeyCrypterWrongPassword_0()
            throws KeyCrypterException {
        ...
        EncryptedData data = keyCrypter.encrypt(" The quick brown fox The quick brown fox The quick brown fox The quick brown fox The quick brown fox The quick brown fox The quick brown fox The quick brown fox".getBytes(), keyCrypter.deriveKey(PASSWORD2));
        System.out.println( "data: " + data);

        try {
            System.out.println( "keyCrypter: " + keyCrypter.decrypt(data, keyCrypter.deriveKey(WRONG_PASSWORD)));
