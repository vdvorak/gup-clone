...
//    }
    ...
    public void testSignatures_0()
        ...
        System.out.println("Sha256Hash: " + Sha256Hash.ZERO_HASH.getBytes());

        byte[] sig = HEX.decode("3046022100dffbc26774fc841bbe1c1362fd643609c6e42dcb274763476d87af2c0597e89e022100c59e3c13b96b316cae9fa0ab0260612c7a133a6fe2b3445b6bf80b3123bf274d");
...
//        // Test that we can construct an ECKey from a private key (deriving the public from the private), then signing a message with it.
//        BigInteger privkey = new BigInteger(1, HEX.decode("180cb41c7c600be951b5d3d0a7334acc7506173875834f7a6c4c786a28fcbb19"));
//        ECKey key = ECKey.fromPrivate(privkey);
//        byte[] output = key.sign(Sha256Hash.ZERO_HASH).encodeToDER();
...
//    }
    ...
    @Test
    public void testPublicKeysAreEqual_0() {
        System.out.println( "1. ||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||");

        ECKey     key = new ECKey();
        ECKey pubKey1 = ECKey.fromPublicOnly(key.getPubKeyPoint());
        System.out.println("pubKey1: " + pubKey1.isCompressed());

        ECKey pubKey2 = pubKey1.decompress();
        System.out.println("pubKey2: " + pubKey2);
        System.out.println("pubKey1 (hashCode): " + pubKey1.hashCode());
        System.out.println("pubKey2 (hashCode): " + pubKey2.hashCode());
    }
