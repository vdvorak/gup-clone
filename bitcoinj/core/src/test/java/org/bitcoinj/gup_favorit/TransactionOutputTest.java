...
public class TransactionOutputTest extends TestWithWallet {
    ...
    @Test
    public void testMultiSigOutputToString_0()
            throws Exception {
        System.out.println( "1. ||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||");

        sendMoneyToWallet(AbstractBlockChain.NewBlockType.BEST_CHAIN, Coin.COIN);
        ECKey myKey = new ECKey();
        System.out.println("getPrivateKeyAsHex:     " + myKey.getPrivateKeyAsHex());
        System.out.println("getEncryptedPrivateKey: " + myKey.getEncryptedPrivateKey());

        System.out.println( );

        System.out.println("getPublicKeyAsHex:  " + myKey.getPublicKeyAsHex());
        System.out.println("getPubKeyHash:      " + myKey.getPubKeyHash());
        System.out.println("getPubKey:          " + myKey.getPubKey());
        System.out.println("getPubKeyPoint:     " + myKey.getPubKeyPoint());
...
//    }
    ...
    @Test
    public void testP2SHOutputScript_0()
            throws Exception {
...
//    }
    ...
    @Test
    public void getMinNonDustValue_0()
            throws Exception {
