...
//        PaymentRequest.Builder paymentRequest = minimalPaymentRequest().toBuilder();
//
//        // Sign
...
//    }
    ...
    private PaymentRequest minimalPaymentRequest() {
        ...
        PaymentRequest.Builder paymentRequest = PaymentRequest.newBuilder();
...
//        // Create
//        Payment paymentMessage = Payment.newBuilder().build();
