...
//    }
    ...
    public void testAddSignedInputThrowsExceptionWhenScriptIsNotToRawPubKeyAndIsNotToAddress_0() {
//        privateKey = keyUtils.wifToPrivateKey("5HusYj2b2x4nroApgfvaSfKYZhRbKFH41bVyPooymbC6KfgSXdD")
...
//        System.out.println("priv:                   " + key0.priv);
        ...
        System.out.println("getPubKey:              " + key0.getPubKey());
        System.out.println("getPubKeyHash:          " + key0.getPubKeyHash());
        System.out.println("getPubKeyPoint:         " + key0.getPubKeyPoint());
        System.out.println("getPublicKeyAsHex:      " + key0.getPublicKeyAsHex());

        System.out.println();

        System.out.println("getPrivateKeyAsHex:     " + key0.getPrivateKeyAsHex());
        System.out.println("getPrivKey:             " + key0.getPrivKey());
        System.out.println("getPrivKeyBytes:        " + key0.getPrivKeyBytes());
        System.out.println("getEncryptedPrivateKey: " + key0.getEncryptedPrivateKey());

        System.out.println();

        System.out.println("sha256:                 " +  Utils.HEX.decode("1822140047877020072616539601954176191680212346491346223591653617") );
        Sha256Hash sha2561 = new Sha256Hash("1822140047877020072616539601954176191680212346491346223591653617");
        System.out.println("sha256:                 " +  sha2561 );
        Sha256Hash sha2562 = Sha256Hash.wrap("1822140047877020072616539601954176191680212346491346223591653617");
        System.out.println("sha256:                 " +  sha2562 );

        byte[] CDRIVES = new byte[] { (byte)0xe0, 0x4f, (byte)0xd0,
                0x20, (byte)0xea, 0x3a, 0x69, 0x10, (byte)0xa2, (byte)0xd8, 0x08, 0x00, 0x2b,
                0x30, 0x30, (byte)0x9d };
        Sha256Hash sha2563 = Sha256Hash.create(CDRIVES);
        System.out.println("sha256:                 " +  sha2563 );
