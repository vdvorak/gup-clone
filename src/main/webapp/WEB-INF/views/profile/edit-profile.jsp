    ...
    <div class="moreInformation">
        ...
        <div id="moreInformation-form">
            ...
            <%--<div id="contactEmailsBlock" class="input_email_fields_wrap">--%>
                ...
                <%--<div class="email-input-unit"><input type="text" name="myemail" class="form-info-input"><a href="#" class="remove_field"><img--%>
                        <%--src="/resources/img/minus.png" with="20" height="20"></a></div>--%>
...
<%--&lt;%&ndash;<div class="input_email_fields_wrap">Контактный e-mail&ndash;%&gt;--%>
<%--&lt;%&ndash;<button class="add_email_field_button">Добавить -mail</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;<div class="email-input-unit"><input type="text" name="myemail"><a href="#" class="remove_field"><img&ndash;%&gt;--%>
<%--&lt;%&ndash;src="/resources/img/minus.png" with="20" height="20"></a></div>&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
...
<%--<input type="email" name="contactEmail" id="contactEmail-0" class="form-info-input">--%>
...
<%--<div class="soc-input-group">--%>
<%--&lt;%&ndash;<input class="input-info-normal" type="text" name="FACEBOOK" placeholder="Ссылка на Facebook">&ndash;%&gt;--%>
<%--</div>--%>
<%--</div>--%>
<%--</div>--%>
