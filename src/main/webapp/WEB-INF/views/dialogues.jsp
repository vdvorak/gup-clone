                                    ...
                                    <c:forEach items="${dialogue.members}" var="member" varStatus="status">
                                        <a rel="example_group"
                                           href="/dialogue/id/${member.id}">
                                            <img alt=""
                                                 src="/api/rest/fileStorage/PROFILE/file/read/id/${member.userPicId}"
                                                 width="150"
...
<script>
    ...
    window.setInterval(function () {
        ...
        if (window.location.hash != storedHash) {
            ...
            window.location.href = "/dialogues/" + storedHash.substring(6) + "?" + $.param(getParams);
        }
    }, 100);
    ...
    var goSearch = function () {
        ...
        if (storedHash.substring(6) === "") {
            window.location.href = "/dialogues/1?" + $.param(getParams);
        } else {
