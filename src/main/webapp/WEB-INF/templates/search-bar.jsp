    ...
    <div class="search">
        ...
        <div id="offerFilterBlock" class="hidefilter" style="display: none">
            <div class="filterADS">
                ...
                <div class="ItemADS">
                    <a id="35" href="#" data-url-param="category1lvl"><img src="/resources/images/Zoo.png"
                                                                           alt="Zoo"></a>
                    <a href="#">Zoo</a>
                ...
                <div class="ItemADS">
                    <a id="891" href="#" data-url-param="category1lvl"><img src="/resources/images/StyleAndFashion.png"
                ...
                <div class="ItemADS">
                    <a id="903" href="#" data-url-param="category1lvl"><img src="/resources/images/SportAndHobby.png"
                                                                            alt="SportAndHobby"></a>
                ...
                <div class="ItemADS">
                    <a id="37" href="#" data-url-param="category1lvl"><img src="/resources/images/Equipment.png"
                                                                           alt="Equipment"></a>
                    <a href="#">Техника</a>
                ...
                <div class="ItemADS">
                    <a id="899" href="#" data-url-param="category1lvl"><img src="/resources/images/HouseAndCottage.png"
                ...
                <div class="ItemADS">
                    <a id="exchange" href="#" data-url-param="category1lvl"><img src="/resources/images/Barter.png"
                                                                                 alt="Barter"></a>
                    <a href="#">Бартер</a>
                ...
                <div class="ItemADS">
                    <a id="1" href="#" data-url-param="category1lvl"><img src="/resources/images/TheProperty.png"
                                                                          alt="TheProperty"></a>
                ...
                <div class="ItemADS">
                    <a id="3" href="#" data-url-param="category1lvl"><img src="/resources/images/Transport.png"
                                                                          alt="Transport"></a>
                    <a href="#">Транспорт</a>
                ...
                <div class="ItemADS">
                    <a id="7" href="#" data-url-param="category1lvl"><img
                ...
                <div class="ItemADS">
                    <a id="1435" href="#" data-url-param="category1lvl"><img src="/resources/images/Volunteering.png"
                                                                             alt="Volunteering"></a>
                ...
                <div class="ItemADS">
                    <a id="free" href="#" data-url-param="category1lvl"><img src="/resources/images/IsFree.png"
                                                                             alt="IsFree"></a>
                    <a href="#">Бесплатно</a>
                            ...
                            <ul id="filter-area-box" class="filter-region-body">
                                ...
                                <div class="div-region div-region-left">
                                    <div class="filter-region-elem">
                                        <li class="region-li li-area"><a class="filter-region-a" href="#">Винницкая область</a></li>
