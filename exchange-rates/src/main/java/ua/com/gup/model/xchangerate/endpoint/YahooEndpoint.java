...
public class YahooEndpoint extends EndpointFactory {
	 ...
	 */
	public long getTimestamp(Currency currency)
            throws JSONException, CurrencyNotSupportedException
    {
	 ...
	 * This method also stores the rates for the currencies it retrieves timestamp for.
     * This makes it fast for currency lookup during conversion
	 *
	 * @param currency
