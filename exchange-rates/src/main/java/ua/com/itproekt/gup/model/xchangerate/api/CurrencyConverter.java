...
import ua.com.itproekt.gup.model.xchangerate.endpoint.EndpointFactory;
...
public class CurrencyConverter implements Converter {
	 ...
	 * This rate decides the time for which the conversion rate is considered to be usable for the currency.
	 * When this time in seconds exceeds for the currency a fresh request is sent and exchange rates are cached.
	 *
	 * @param seconds int
	 */
	 ...
	 * @throws ServiceException
	 */
	public void updateResource(Currency fromCurrency, Currency toCurrency)
            throws CurrencyNotSupportedException, StorageException, JSONException, EndpointException, ServiceException
    {
		if (!endpointFactory.checkRatesUsable(fromCurrency)
                || !endpointFactory.checkRatesUsable(toCurrency)) {
